...
export default function BlogSection() {
  return (
    <section className="bg-base-200 animate-fade-in">
      <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          <article className="p-6 bg-base-100 rounded-lg border border-gray-200 shadow-md dark:bg-base-300 dark:border-gray-700 hover:scale-105 hover:shadow-lg transition-transform duration-300 animate-fade-in-up">
            ...
            <p className="mb-5 font-light text-black dark:text-black">
